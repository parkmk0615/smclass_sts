...
public class FController {
	...
	public String oauth(String code) {
		...
		String client_id = "843b233f4212c0e2231768801c956cd8";
		String redirect_uri = "http://localhost:8181/kakao/oauth";
		String content_type ="application/x-www-form-urlencoded;charset=utf-8\r\n";
		
		// http url 전송 : httpURLConnection
		...
		//response에서 받은 데이터(json)를 OauthToken 객체 저장
		...
		//url
		String oatuhUrl2 ="https://kapi.kakao.com/v2/user/me";
		
		//http 전송 - 카카오 회원 정보 : 닉네임, 사진, 아이디, 성별 등등을
		ResponseEntity<String> response2 = 
		rt.exchange(oatuhUrl2, HttpMethod.POST, kakaoTokenRequest2, String.class);
		...
		return "kakaoProfile 닉네임: " +kakaoProfile.getProperties().getNickname();
	}
}
